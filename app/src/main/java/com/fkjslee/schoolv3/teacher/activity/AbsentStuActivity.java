...
public class AbsentStuActivity extends AppCompatActivity {
    ...
    private ListView lvAbsentStudent;
    ...
    private void initView() {
        lvAbsentStudent = (ListView) findViewById(R.id.lv_absentStudent);
    ...
    private void setData(String result) {
        ...
        SimpleAdapter adapter = new SimpleAdapter(this, items, R.layout.absent_student_item,
                new String[]{"sId", "sName"}, new int[]{R.id.absent_studentID, R.id.absent_student_name});
        lvAbsentStudent.setAdapter(adapter);
    }
